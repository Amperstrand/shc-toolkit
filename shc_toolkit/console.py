...
class ConsoleSession:
    ...
    def login(self):
        ...
        page = self._page
        page.goto(f"{PORTAL_BASE}/client/login/", wait_until="networkidle")
        page.fill('input[placeholder="Email Address"]', self.email)
    ...
    def get_service_password(self, service_id: int) -> tuple[str, str]:
        """Retrieve (username, password) from the portal Service Info page."""
        ...
        password_input = page.query_selector('input[placeholder="Server password"]')
    ...
    def open_console(self, service_id: int):
        ...
        iframe = page.query_selector("#serviceConsoleFrame")
        if not iframe:
    ...
    def _console_frame(self):
        ...
        return self._page.locator("#serviceConsoleFrame").content_frame()
    ...
    def paste_text(self, text: str):
        ...
        self._page.wait_for_timeout(min(len(text) * 15, 10000))
