...
from ...models.mount_virtual_machine_iso_response_200 import (
    MountVirtualMachineIsoResponse200,
)
from ...models.vm_iso_mount_request import VmIsoMountRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/vm/{service_id}/iso/mount".format(
...
) -> Error | MountVirtualMachineIsoResponse200 | None:
    if response.status_code == 200:
        response_200 = MountVirtualMachineIsoResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | MountVirtualMachineIsoResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | MountVirtualMachineIsoResponse200
    """
