...
from ...models.get_virtual_machine_summary_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/vm/{service_id}/summary".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetVirtualMachineSummaryResponse200.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | GetVirtualMachineSummaryResponse200
    """
