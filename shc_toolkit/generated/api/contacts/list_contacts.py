...
def sync_detailed(
    *,
    ...
    """List the client's contacts

     Lists the authenticated customer's contacts (primary, billing, and other), client-scoped. Indicates
    whether each contact has a portal login. Write paths to the primary contact remain on
    /account/contact.
