...
def sync_detailed(
    ...
    *,
    ...
    """Get a contact
     ...
     Returns one client-owned contact with its phone/fax numbers and granted permission areas. 404 for a
    contact not owned by the authenticated client.
