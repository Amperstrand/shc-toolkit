...
from ...models.verify_virtual_machine_snapshot_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/vm/{service_id}/snapshots/verify".format(
...
) -> Error | VerifyVirtualMachineSnapshotResponse200 | None:
    if response.status_code == 200:
        response_200 = VerifyVirtualMachineSnapshotResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | VerifyVirtualMachineSnapshotResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Acknowledge a snapshot verify

     Synchronous no-op acknowledgement of a verify request for one of this VM's own snapshot volumes. No
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | VerifyVirtualMachineSnapshotResponse200
    """
