...
from ...models.get_vm_console_availability_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/vm/{service_id}/console".format(
...
) -> Error | GetVmConsoleAvailabilityResponse200 | None:
    if response.status_code == 200:
        response_200 = GetVmConsoleAvailabilityResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | GetVmConsoleAvailabilityResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | GetVmConsoleAvailabilityResponse200
    """
