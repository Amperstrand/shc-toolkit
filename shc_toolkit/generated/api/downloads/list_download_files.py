...
from ...models.list_download_files_response_200 import ListDownloadFilesResponse200
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ListDownloadFilesResponse200.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Error | ListDownloadFilesResponse200
    """
