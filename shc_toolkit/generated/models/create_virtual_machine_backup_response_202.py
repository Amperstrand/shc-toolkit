...
T = TypeVar("T", bound="CreateVirtualMachineBackupResponse202")


@_attrs_define
class CreateVirtualMachineBackupResponse202:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_virtual_machine_backup_response_202 = cls(
            data=data,
        )

        create_virtual_machine_backup_response_202.additional_properties = d
        return create_virtual_machine_backup_response_202
