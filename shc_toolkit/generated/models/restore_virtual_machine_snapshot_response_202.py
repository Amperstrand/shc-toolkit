...
T = TypeVar("T", bound="RestoreVirtualMachineSnapshotResponse202")
...
class RestoreVirtualMachineSnapshotResponse202:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_virtual_machine_snapshot_response_202 = cls(
            data=data,
        )

        restore_virtual_machine_snapshot_response_202.additional_properties = d
        return restore_virtual_machine_snapshot_response_202
