...
class EventSubscriptionCreateRequest:
    ...
    url: str
    """ HTTPS webhook destination. The server accepts only standard-port HTTPS URLs whose host resolves to public IP
    addresses. Registration and every delivery reject loopback, link-local, private, metadata, .local, non-HTTPS,
    non-standard-port, and DNS-rebound targets. """
