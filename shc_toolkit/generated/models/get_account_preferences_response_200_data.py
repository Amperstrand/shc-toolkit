...
T = TypeVar("T", bound="GetAccountPreferencesResponse200Data")
...
class GetAccountPreferencesResponse200Data:
    ...
    autodebit: bool | None
    editable: GetAccountPreferencesResponse200DataEditable
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        editable = GetAccountPreferencesResponse200DataEditable.from_dict(
            d.pop("editable")
        )

        get_account_preferences_response_200_data = cls(
            language=language,
            default_currency=default_currency,
            inv_method=inv_method,
            inv_address_to=inv_address_to,
        ...
        return get_account_preferences_response_200_data
