...
T = TypeVar("T", bound="VmStorageDeleteResponse")


@_attrs_define
class VmStorageDeleteResponse:
    """
    Attributes:
        ...
        message (str):  Example: Backup deleted successfully..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vm_storage_delete_response = cls(
            service_id=service_id,
            backup_id=backup_id,
            deleted=deleted,
            message=message,
        ...
        vm_storage_delete_response.additional_properties = d
        return vm_storage_delete_response
