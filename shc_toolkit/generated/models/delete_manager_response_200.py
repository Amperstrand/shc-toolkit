...
T = TypeVar("T", bound="DeleteManagerResponse200")
...
class DeleteManagerResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_manager_response_200 = cls(
            data=data,
        )

        delete_manager_response_200.additional_properties = d
        return delete_manager_response_200
