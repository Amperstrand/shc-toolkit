...
T = TypeVar("T", bound="CancelVirtualMachineResponse200")
...
class CancelVirtualMachineResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_virtual_machine_response_200 = cls(
            data=data,
        )

        cancel_virtual_machine_response_200.additional_properties = d
        return cancel_virtual_machine_response_200
