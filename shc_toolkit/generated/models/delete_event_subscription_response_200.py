...
T = TypeVar("T", bound="DeleteEventSubscriptionResponse200")


@_attrs_define
class DeleteEventSubscriptionResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_event_subscription_response_200 = cls(
            data=data,
        )

        return delete_event_subscription_response_200
