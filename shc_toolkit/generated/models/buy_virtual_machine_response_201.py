...
T = TypeVar("T", bound="BuyVirtualMachineResponse201")


@_attrs_define
class BuyVirtualMachineResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        buy_virtual_machine_response_201 = cls(
            data=data,
        )

        buy_virtual_machine_response_201.additional_properties = d
        return buy_virtual_machine_response_201
