...
T = TypeVar("T", bound="UpgradeServiceResponse202")
...
class UpgradeServiceResponse202:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VmUpgradeResponse.from_dict(d.pop("data"))

        upgrade_service_response_202 = cls(
            data=data,
        )

        upgrade_service_response_202.additional_properties = d
        return upgrade_service_response_202
