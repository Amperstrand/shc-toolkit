...
T = TypeVar("T", bound="EnrollAffiliateResponse201")
...
class EnrollAffiliateResponse201:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enroll_affiliate_response_201 = cls(
            data=data,
        )

        enroll_affiliate_response_201.additional_properties = d
        return enroll_affiliate_response_201
