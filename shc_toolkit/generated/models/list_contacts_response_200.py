...
if TYPE_CHECKING:
    from ..models.list_contacts_response_200_items_item import (
...
class ListContactsResponse200:
    """
    Attributes:
        items (list[ListContactsResponse200ItemsItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ListContactsResponse200ItemsItem.from_dict(items_item_data)
