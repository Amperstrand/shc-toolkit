...
T = TypeVar("T", bound="ChangeVirtualMachineTermResponse200")
...
class ChangeVirtualMachineTermResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ChangeVirtualMachineTermResponse200Data.from_dict(d.pop("data"))

        change_virtual_machine_term_response_200 = cls(
            data=data,
        )

        change_virtual_machine_term_response_200.additional_properties = d
        return change_virtual_machine_term_response_200
