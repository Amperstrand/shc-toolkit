...
if TYPE_CHECKING:
    from ..models.get_virtual_machine_summary_response_200_data_recent_jobs_item import (
...
T = TypeVar("T", bound="GetVirtualMachineSummaryResponse200Data")


@_attrs_define
class GetVirtualMachineSummaryResponse200Data:
    id: int
    hostname: None | str
    os_user: None | str
    ...
    """ Service lifecycle status (renamed from the DB status field). """
    ...
    """ True if any of the recent jobs is pending or running. """
    recent_jobs: list[GetVirtualMachineSummaryResponse200DataRecentJobsItem] | Unset = (
        UNSET
    )
    """ The five most recent provisioning/lifecycle jobs for this VM (placement fields omitted). """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        recent_jobs: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.recent_jobs, Unset):
            recent_jobs = []
            for recent_jobs_item_data in self.recent_jobs:
        ...
        if recent_jobs is not UNSET:
            field_dict["recent_jobs"] = recent_jobs
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        _recent_jobs = d.pop("recent_jobs", UNSET)
        recent_jobs: (
            list[GetVirtualMachineSummaryResponse200DataRecentJobsItem] | Unset
        ) = UNSET
        if _recent_jobs is not UNSET:
            recent_jobs = []
            for recent_jobs_item_data in _recent_jobs:
                recent_jobs_item = (
                    GetVirtualMachineSummaryResponse200DataRecentJobsItem.from_dict(
                        recent_jobs_item_data
                    )
                )
        ...
        get_virtual_machine_summary_response_200_data.additional_properties = d
        return get_virtual_machine_summary_response_200_data
