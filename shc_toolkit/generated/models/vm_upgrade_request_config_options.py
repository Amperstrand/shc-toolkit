...
T = TypeVar("T", bound="VmUpgradeRequestConfigOptions")


@_attrs_define
class VmUpgradeRequestConfigOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        vm_upgrade_request_config_options = cls()
        ...
        vm_upgrade_request_config_options.additional_properties = additional_properties
        return vm_upgrade_request_config_options
