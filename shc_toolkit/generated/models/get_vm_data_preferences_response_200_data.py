...
if TYPE_CHECKING:
    ...
    from ..models.get_vm_data_preferences_response_200_data_notify import (
        GetVmDataPreferencesResponse200DataNotify,
    )
    from ..models.get_vm_data_preferences_response_200_data_snapshot import (
        GetVmDataPreferencesResponse200DataSnapshot,
    )


T = TypeVar("T", bound="GetVmDataPreferencesResponse200Data")
...
class GetVmDataPreferencesResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup = GetVmDataPreferencesResponse200DataBackup.from_dict(d.pop("backup"))

        snapshot = GetVmDataPreferencesResponse200DataSnapshot.from_dict(
            d.pop("snapshot")
        )

        notify = GetVmDataPreferencesResponse200DataNotify.from_dict(d.pop("notify"))
        ...
        get_vm_data_preferences_response_200_data = cls(
            service_id=service_id,
            backup=backup,
            snapshot=snapshot,
            notify=notify,
        ...
        get_vm_data_preferences_response_200_data.additional_properties = d
        return get_vm_data_preferences_response_200_data
