...
T = TypeVar("T", bound="GetContactPermissionOptionsResponse200")


@_attrs_define
class GetContactPermissionOptionsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_contact_permission_options_response_200 = cls(
            data=data,
        )

        return get_contact_permission_options_response_200
